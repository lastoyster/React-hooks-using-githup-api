...
function App() {
  ...
  return (
    <div
      className="wrapper"
      style={darktheme === true ? darkTheme : lightTheme}
    >
      <h1 className="title">React Hooks Example</h1>
      <p className="gitlink">
        <a
          href="https://github.com/lastoyster/react-hooks-example"
          style={{
            color: darktheme === true ? darktheme.color : lightTheme.color
          }}
        >
      ...
      <button
        onClick={() => isDarkTheme(!darktheme)}
        className="themeButton"
        style={darktheme === true ? lightTheme : darkTheme}
      >
        Change theme
      </button>
